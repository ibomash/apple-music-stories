...
## Current Task Order
1. TASK-26 - Phase 4: Story picker + local bundle ingestion
2. TASK-36 - Document full iOS app build steps
3. TASK-35 - Add iOS UI snapshot + diagnostics banner tests
